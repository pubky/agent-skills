...
approves. The names below are from **`pubky-homeserver` HEAD examples**, *not* the 0.9.3-pinned CI
...
<sub>HEAD example (NOT 0.9.3-pinned — verify before use). Source: [`pubky-homeserver/examples/rust/3-auth_flow/authenticator.rs`](https://github.com/pubky/pubky-homeserver/blob/main/examples/rust/3-auth_flow/authenticator.rs)</sub>
